...
//The RP2350 has GPIOs 30 and above, but only in the QFN-80 packeage.
 ...
 // #define DIG_26_MODE 0
  ...
  // ---------- SPI0 / ADS1256 pin assignments ----------
  #define ADS1256_PIN_MISO  16  // SPI0 RX  -> ADS1256 DOUT
  #define ADS1256_PIN_CS    17  // GPIO CS  -> ADS1256 /CS  (active-low, SW-controlled)
  #define ADS1256_PIN_SCLK  18  // SPI0 SCK -> ADS1256 SCLK
  #define ADS1256_PIN_MOSI  19  // SPI0 TX  -> ADS1256 DIN
  #define ADS1256_PIN_DRDY  20  // GPIO in  -> ADS1256 /DRDY (active-low)
